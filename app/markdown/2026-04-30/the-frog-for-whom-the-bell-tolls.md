...
(カエルの<ruby>為<rp>(</rp><rt>ため</rt><rp>)</rp></ruby>に<ruby>鐘<rp>(</rp><rt>かね</rt><rp>)</rp></ruby>は<ruby>鳴<rp>(</rp><rt>な</rt><rp>)</rp></ruby>る)
...
<div class="col-3">
<center>
<img src="https://storage.googleapis.com/sethmlarson-dev-static-assets/FrogGameCartridge.png" style="max-width: 100%;"/>
...
[video by AntDude](https://youtu.be/lbq66dNtJL4?si=kZfOxUODUeJxEwOB&t=245)
...
After further research I stumbled across a project by [Iván Delgado](https://toruzz.com) ([Bluesky](https://bsky.app/profile/toruzz.com), [YouTube](https://www.youtube.com/@toruzz))
to [create a colorization patch](https://www.youtube.com/watch?v=xNaSz-vWmDQ) for “Frog Game” that appears to [still be in progress](https://bsky.app/profile/toruzz.com/post/3m36q7kjmps23).
I was already a subscriber to [Iván’s blog](https://toruzz.com/blog) and had previously
read their series of posts about [colorizing Game Boy games](https://toruzz.com/blog/how-to-colorize-gb-games-first-steps).

Everything I read about the game made me want to play: the game
was affordable, short ([7 hours to beat](https://github.com/sethmlarson/retroachievements-play-activity)), with a light and funny narrative, and
...
<center>
<p>
<img src="https://storage.googleapis.com/sethmlarson-dev-static-assets/FrogGameJpn.PNG" style="max-width: 100%;">
...
<center>
<p>
<img src="https://storage.googleapis.com/sethmlarson-dev-static-assets/FrogGameEng.PNG" style="max-width: 100%;">
...
While game’s title is a reference to “[For Whom the Bell Tolls](https://en.wikipedia.org/wiki/For_Whom_the_Bell_Tolls)” by Ernest Hemingway,
the [game’s story definitely isn’t](https://www.youtube.com/watch?v=MPTMQQLD3FI).
...
The developers of Frog Game, [Intelligent Systems](https://en.wikipedia.org/wiki/Intelligent_Systems), also developed
my favorite game of all time: “[Paper Mario: The Thousand Year Door](https://en.wikipedia.org/wiki/Paper_Mario:_The_Thousand-Year_Door)”.
...
likely a reference to the [Nintendo Famicom](https://en.wikipedia.org/wiki/Nintendo_Entertainment_System). From just the name alone
...
including an [Assist Trophy](https://supersmashbros.fandom.com/wiki/Prince_of_Sabl%C3%A9) and
Single-Player Challenge in Super Smash Bros. Mad Scienstein
from Nantendo Inc. cameos in [Wario Land 3, Wario Land 4, and Dr. Mario 64](https://www.mariowiki.com/Mad_Scienstein).

## Gameplay

The rumors about Link’s Awakening [sharing an
engine](https://www.youtube.com/watch?v=iaOhJbSufJI) with Frog Game likely come from using a mix
...
assembly of both games are [fairly sure the two games don’t share an engine](https://toruzz.com/blog/la-kaeru-technical-comparison/),
...
to the [“curses” from Black Chests in Paper Mario](https://www.mariowiki.com/Black_chest#:~:text=However%2C%20the%20curses%20benefit%20Mario%2C%20giving%20him%20new%20paper%20abilities)
or [Li’l Devils from Link’s Awakening](https://zeldawiki.wiki/wiki/Li%27l_Devil).
